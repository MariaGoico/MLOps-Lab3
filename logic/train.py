...
def train_model(config, class_names):
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        # Plot and log curves
        plot_path = plot_curves(train_losses, val_losses, train_accs, val_accs, run_name)
...
def main():
    ...
    temp_dataset = datasets.OxfordIIITPet(root=DATA_DIR, split="trainval", download=True, transform=transform)
